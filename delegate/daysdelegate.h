...
#ifndef DAYSDELEGATE_H
#define DAYSDELEGATE_H
...
class DaysDelegate : public QStyledItemDelegate
{
public:
  DaysDelegate();                                           // constructor
